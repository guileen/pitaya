...
var req = exports = module.exports = http.IncomingMessage.prototype
...
req.fulluri = req.fullurl = function(path) {
  return (this.isSecure ? 'https://' : 'http://') + this.headers.host + path;
}
